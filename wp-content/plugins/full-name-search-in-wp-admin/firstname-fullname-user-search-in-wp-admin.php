...
Plugin URI: https://wordpress.org/plugins/full-name-search-in-wp-admin/
...
if(version_compare($wp_version,"4.1","<")) {
	exit(__('User First Name / Full Name Search In WP-admin requires WordPress version4.1 or higher. 
