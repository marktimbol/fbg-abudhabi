	...
	<tr id="ticket_form" class="ticket_form">
		<td colspan="2" class="tribe_sectionheader">
			...
			<table id="ticket_form_table" class="eventtable ticket_form">
				...
				<tr class="ticket">
					<td><label
							for="ticket_membership_type"><?php esc_html_e( 'Type of membership:', 'event-tickets' ); ?></label>
					</td>
					<td>
						<input type="radio" name="ticket_membership_type" class="ticket_field" value="paid" /><span>Paid</span>
						<input type="radio" name="ticket_membership_type" class="ticket_field" value="unpaid" /><span>Unpaid</span>
					</td>
				</tr>
				<tr class="ticket">
					<td><label
