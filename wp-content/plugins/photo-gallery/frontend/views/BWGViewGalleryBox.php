...
class BWGViewGalleryBox {
  ...
  public function display() {
    ...
    $enable_image_filmstrip = WDWLibrary::esc_script('get', 'enable_image_filmstrip', 0, 'int');
    ...
    $enable_image_ecommerce = WDWLibrary::esc_script('get', 'enable_image_ecommerce', 0, 'int');
    ...
    $comment_moderation = $wd_bwg_options->comment_moderation;
    ...
    if ($wd_bwg_options->enable_addthis && $wd_bwg_options->addthis_profile_id) {
      ?>
      <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=<?php echo $wd_bwg_options->addthis_profile_id; ?>" async="async"></script>
      <?php
    }
    ?>
    <style>
      ...
      .bwg_inst_play {
        ...
        width: 50px;
        height: 50px;
        background-image: url('<?php echo WD_BWG_URL . '/images/play.png'; ?>');
      ...
      .bwg_inst_play:hover {
          background: url(<?php echo WD_BWG_URL . '/images/play_hover.png'; ?>) no-repeat;
          background-position: center center;
          background-repeat: no-repeat;
          background-size: cover;
      }
    ...
    <div class="bwg_image_wrap">
      ...
      <div class="bwg_btn_container">
        <div class="bwg_ctrl_btn_container">
          ...
          <i title="<?php echo __('Show rating', 'bwg'); ?>" class="bwg_ctrl_btn bwg_rate fa fa-star"></i>
          <?php }
          $is_embed = preg_match('/EMBED/', $current_filetype) == 1 ? TRUE : FALSE;
          $share_image_url = str_replace('%252F', '%2F', urlencode( $is_embed ? $current_thumb_url : site_url() . '/' . $WD_BWG_UPLOAD_DIR . rawurlencode($current_image_url)));
          if ($enable_image_facebook) {
            ?>
            <a id="bwg_facebook_a" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Facebook', 'bwg'); ?>">
          ...
          if ($enable_image_twitter) {
            ?>
            <a id="bwg_twitter_a" href="https://twitter.com/share?url=<?php echo urlencode($current_url . '#bwg' . $gallery_id . '/' . $current_image_id); ?>" target="_blank" title="<?php echo __('Share on Twitter', 'bwg'); ?>">
          ...
          if ($enable_image_google) {
            ?>
            <a id="bwg_google_a" href="https://plus.google.com/share?url=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Google+', 'bwg'); ?>">
          ...
          if ($enable_image_pinterest) {
            ?>
            <a id="bwg_pinterest_a" href="http://pinterest.com/pin/create/button/?s=100&url=<?php echo urlencode($share_url); ?>&media=<?php echo $share_image_url; ?>&description=<?php echo $current_image_alt . '%0A' . $current_image_description; ?>" target="_blank" title="<?php echo __('Share on Pinterest', 'bwg'); ?>">
          ...
          if ($enable_image_tumblr) {
            ?>
            <a id="bwg_tumblr_a" href="https://www.tumblr.com/share/photo?source=<?php echo $share_image_url; ?>&caption=<?php echo urlencode($current_image_alt); ?>&clickthru=<?php echo urlencode($share_url); ?>" target="_blank" title="<?php echo __('Share on Tumblr', 'bwg'); ?>">
		 ...
		 if(defined('WDPG_ECOMMERCE_NAME') && is_plugin_active(WDPG_ECOMMERCE_NAME.'/'.'photo-gallery-ecommerce.php') && $enable_image_ecommerce == 1  ){
		 
		   ?>				
				<i title="<?php echo __('Ecommerce', 'bwg'); ?>" style="<?php echo $pricelist_id == 0 ? "display:none;": "";?>" class="bwg_ctrl_btn bwg_ecommerce fa fa-shopping-cart" ></i>
		   <?php
		  } 
          ?>
        </div>
          ...
          <div class="bwg_image_hit_container2">
            <span class="bwg_image_hit_spun">
              <div class="bwg_image_hit">
                <div class="bwg_image_hits"><?php echo __('Hits: ', 'bwg'); ?><span><?php echo $current_image_hit_count; ?></span></div>
              </div>
            </span>
          </div>
        </div>
                      ...
                      if (typeof jQuery().raty !== 'undefined') {
                        if (jQuery.isFunction(jQuery().raty)) {
                          jQuery("#bwg_star").raty({
                            ...
                            noRatedMsg : "<?php echo __('Not rated yet.', 'bwg'); ?>",
                  ...
                  <span class="bwg_popup_image_spun2" style="display: <?php echo (!$is_embed ? 'table-cell' : 'block'); ?>; vertical-align: middle; text-align: center; height: 100%;">
                    <?php 
                      ...
                      <?php 
                        ...
                        <?php echo $is_embed_instagram_video ? '<div class="bwg_inst_play_btn_cont" onclick="bwg_play_instagram_video(this)" ><div class="bwg_inst_play"></div></div>' : '';
    ...
    <div class="bwg_comment_wrap bwg_popup_sidebar_wrap">
      <div class="bwg_comment_container bwg_popup_sidebar_container bwg_close">
        <div id="ajax_loading" style="position:absolute;">
          ...
          <span id="loading_div" class="bwg_spider_ajax_loading" style="display:none; text-align:center; position:relative; vertical-align:middle; z-index:10170; background-image:url(<?php echo WD_BWG_URL . '/images/ajax_loader.gif'; ?>); float: none; width:30px;height:30px;background-size:30px 30px; background-repeat: no-repeat; background-position: 50% 50%;">
          </span>
        </div>
        <div class="bwg_comments bwg_popup_sidebar">
          ...
          if (isset($_POST['ajax_task']) && (esc_html(stripslashes($_POST['ajax_task'])) === 'save')) {
            ...
            if ($wd_bwg_options->popup_enable_email && isset($_POST['bwg_email']) && !is_email(stripslashes($_POST['bwg_email']))) {
          ...
          <div id="bwg_comments bwg_popup_sidebar">
            <div title="<?php echo __('Hide Comments', 'bwg'); ?>" class="bwg_comments_close bwg_popup_sidebar_close">
            ...
            <form id="bwg_comment_form" method="post" action="<?php echo $popup_url; ?>">
              ...
              ?>
              <p><input onclick="if (spider_check_required('bwg_name', '<?php echo __('Name', 'bwg'); ?>') <?php if ($wd_bwg_options->popup_enable_email) { ?> || spider_check_required('bwg_email', '<?php echo __('Email', 'bwg'); ?>') || spider_check_email('bwg_email') <?php } ?> || spider_check_required('bwg_comment', '<?php echo __('Comment', 'bwg'); ?>')) { return false;}
                                 ...
                                 return false;"
                        ontouchend="if (spider_check_required('bwg_name', '<?php echo __('Name', 'bwg'); ?>') <?php if ($wd_bwg_options->popup_enable_email) { ?> || spider_check_required('bwg_email', '<?php echo __('Email', 'bwg'); ?>') || spider_check_email('bwg_email') <?php } ?> || spider_check_required('bwg_comment', '<?php echo __('Comment', 'bwg'); ?>')) {return false;}
                                 var cur_image_key = parseInt(jQuery('#bwg_current_image_key').val());
                                 ++data[cur_image_key]['comment_count'];
                                 spider_set_input_value('ajax_task', 'save');
                                 spider_set_input_value('image_id', jQuery('#bwg_popup_image').attr('image_id'));
              ...
              <?php echo (!current_user_can('manage_options') && ($comment_moderation && (isset($_POST['bwg_comment']) && esc_html($_POST['bwg_comment'])))) ? __('Your comment is awaiting moderation', 'bwg') : ''; ?>
				...
				<div class="bwg_ecommerce_container bwg_popup_sidebar_container bwg_close">
					...
					<div class="bwg_ecommerce_panel bwg_popup_sidebar_panel bwg_popup_sidebar" style="text-align:left;">
						<div id="bwg_ecommerce">
							<p title="<?php echo __('Hide Ecommerce', 'bwg'); ?>" class="bwg_ecommerce_close bwg_popup_sidebar_close" >
							...
							<form id="bwg_ecommerce_form" method="post" action="<?php echo $popup_url; ?>">
								<div class="pge_add_to_cart">
									<div>
                    <img src="<?php echo WD_BWG_URL ?>/images/add-to-cart-icon.png" style="vertical-align:bottom;">&nbsp;
                    <span class="pge_add_to_cart_title"><?php echo (__('Add to cart', 'bwg')); ?></span>
                  </div>
									<div>
                    <a href="<?php echo get_permalink($options->checkout_page);?>"><?php echo "<span class='products_in_cart'>".$products_in_cart ."</span> ". __('items', 'bwg'); ?></a> 
                  </div>
								...
								<div class="bwg_ecommerce_body">
									<ul class="pge_tabs" <?php if(count($pricelist_sections)<=1) echo "style='display:none;'"; ?>>
										<li id="manual_li" <?php if(!in_array("manual",$pricelist_sections)) echo "style='display:none;'"; ?> class="pge_active">										
											<a href= "#manual">
												<span class="manualh4" >	
													<?php echo __('Prints and products', 'bwg'); ?>
												</span>
											</a>											
										</li>
									...
									<div class="manual pge_pricelist" id="manual" <?php if( count($pricelist_sections) == 2  || (count($pricelist_sections) == 1 && end($pricelist_sections) == "manual")) echo 'style="display: block;"'; else echo 'style="display: none;"'; ?>  >																	
										<div>
											...
											<div class="product_manual_price_div">
												<p><?php echo $pricelist->manual_title ? __('Name', 'bwg').': '.$pricelist->manual_title : "";?></p>
                                               <?php if ($pricelist->price) {
                                                 ?>
												<p>												
													<span><?php echo __('Price', 'bwg').': '.$options->currency_sign;?></span>
                                          ...
                                          ?>
											<div class="product_manual_desc_div">
												<p>
													<span><?php echo __('Description', 'bwg');?>:</span>
											...
											<div class="image_parameters">
												<p><?php //echo __('Parameters', 'bwg'); ?></p>
												<?php
													$i = 0;
											...
											<?php } ?>
											<p>
												<span><b><?php echo __('Total', 'bwg').': '.$options->currency_sign;?></b></span>
									...
									<div class="downloads pge_pricelist" id="downloads" <?php if( (count($pricelist_sections) == 1 && end($pricelist_sections) == "downloads")) echo 'style="display: block;"'; else echo 'style="display: none;"'; ?> >
										...
										<table>
											<thead>
												<tr>
													<th><?php echo __('Choose', 'bwg'); ?></th>
													<th><?php echo __('Name', 'bwg'); ?></th>
													<th><?php echo __('Dimensions', 'bwg'); ?></th>
													<th><?php echo __('Price', 'bwg'); ?></th>												
												</tr>
											</thead>
											<tbody>
												<?php	
								...
								<div style="margin-top:10px;">	
									<input type="button" class="bwg_submit" value="<?php echo __('Add to cart', 'bwg'); ?>" onclick="onBtnClickAddToCart();">
									<input type="button" class="bwg_submit" value="<?php echo __('View cart', 'bwg'); ?>" onclick="onBtnViewCart()">
					...
					if(type != ""){
						...
						if(type == "manual"){
							...
							if(downloadItems.length == 0)	{
								jQuery(".add_to_cart_msg").html("<?php echo __("Please select at least one item", 'bwg');?>");
								return ;
							}
						...
						jQuery(".add_to_cart_msg").html("<?php echo __("Please select Prints and products or Downloads", 'bwg');?>");
					}
    ...
    <script>
      ...
      function bwg_change_image(current_key, key, data, from_effect) {
        ...
        var ecommerceACtive = '<?php echo (defined('WDPG_ECOMMERCE_NAME') && is_plugin_active(WDPG_ECOMMERCE_NAME.'/'.'photo-gallery-ecommerce.php') ) == true ? 1 : 0 ; ?>';
          ...
          if (typeof data[current_key] != 'undefined') {
            ...
            function bwg_afterload() {
              ...
              if (is_embed) {
                ...
                var bwg_share_image_url = "<?php echo urlencode(site_url() . '/' . $WD_BWG_UPLOAD_DIR); ?>" + encodeURIComponent(encodeURIComponent(data[key]['image_url']));
              }
              ...
              if (jQuery(".bwg_ecommerce_container").hasClass("bwg_open")) {
                ...
                if(data[key]["pricelist"] == 0){
                  ...
                  jQuery(".bwg_ecommerce").attr("title", "<?php echo __('Show Ecommerce', 'bwg'); ?>");
	 ...
	 function bwg_animate_image_box_for_show_sidebar(){
		var bwg_comment_container = jQuery(".bwg_comment_container").width() || jQuery(".bwg_ecommerce_container").width();
          jQuery(".bwg_image_wrap").animate({
            ...
            width: jQuery("#spider_popup_wrap").width() - bwg_comment_container}, 500);
          jQuery(".bwg_image_container").animate({
            width: jQuery("#spider_popup_wrap").width() - <?php echo ($filmstrip_direction == 'vertical' ? $image_filmstrip_width : 0); ?> - bwg_comment_container}, 500);
          jQuery(".bwg_popup_image").animate({
     ...
     function bwg_comment() {		
      ...
      function bwg_ecommerce() {
        ...
        if (jQuery(".bwg_ecommerce_container").hasClass("bwg_open")) {
         ...
         // jQuery(".spider_popup_close_fullscreen").show();
          ...
          jQuery(".bwg_ecommerce").attr("title", "<?php echo __('Hide Ecommerce', 'bwg'); ?>");
          get_ajax_pricelist();
        }
      }
      ...
      /* jQuery(document).ready(function () { */
        ...
        jQuery(".bwg_rate").on(bwg_click, function() {
          if (jQuery(".bwg_image_rate_container1").css("display") == 'none') {
            jQuery(".bwg_image_rate_container1").css("display", "table-cell");
            jQuery(".bwg_rate").attr("title", "<?php echo __('Hide rating', 'bwg'); ?>");
          }
          else {
            jQuery(".bwg_image_rate_container1").css("display", "none");
            jQuery(".bwg_rate").attr("title", "<?php echo __('Show rating', 'bwg'); ?>");
          }
        });
        /* Open/close comments.*/
