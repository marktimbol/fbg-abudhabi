  ...
  public function crop() {
    ...
    if ($edit_type == 'crop') {
      ...
      elseif ($type_orig == 1) {
        ...
        ?>
        <div class="thumb_message"><strong><?php echo __("You can't crop this type of image.", 'bwg_back'); ?></strong></div>
        <?php
      }
    }
    ...
    <?php
    if ($edit_type == 'crop') {
      ?><div class="thumb_message" id="croped_message"><strong><?php echo __('The thumbnail successfully croped.', 'bwg_back'); ?></strong></div><?php
    }
    else {
      ?><div class="thumb_message" id="thumb_message"><strong><?php echo __('Select the area for the thumbnail.', 'bwg_back'); ?></strong></div><?php
    }
    ?>
        ...
        <table style="height: inherit; top: 45px; position: absolute ;width: inherit; margin: 0 auto;">
          <tr>
            <td class="thumb_preview_td" colspan="2">
              ...
              <label for="chb"><?php echo __('Keep aspect ratio', 'bwg_back'); ?></label>
            </td>
          </tr>
          <tr>
      ...
      <div class="main_cont" style="height: <?php echo $popup_height; ?>px;">
        <div class="cont_for_effect">          
          ...
          <div class="effect_cont">
            ...
            <p class="effect_title"><?php echo __('Slate', 'bwg_back'); ?></p>
          </div>
          <div class="effect_cont">
            <img class="effect" onclick="spider_rotate('saturate', 'bwg_rotate_image')" src="<?php echo WD_BWG_URL . '/images/effects/saturate.png'; ?>"/>				  
            <p class="effect_title"><?php echo __('Saturate', 'bwg_back'); ?></p>		 
         </div>
        </div>		
        <div class="reset_cont">
          <a class="reset_img" onclick="if (confirm('<?php echo addslashes(__('Do you want to reset the image?', 'bwg_back')); ?>')) spider_rotate('recover', 'bwg_rotate_image'); else return false; "><?php echo __('Reset image', 'bwg_back'); ?></a>
        </div>
        <div class="flip_cont" >		  
                    ...
                    <div class="brightness_part_1">
                      <div class="brightness_butt">
                        <div class="contForBrightness">
                          <div class="brightness_title"><?php echo __('Brightness', 'bwg_back'); ?></div>
                          ...
                          <div class="tooltip_for_press"><?php echo __('Press for result', 'bwg_back'); ?></div>
                        </div>
                      </div>
                    ...
                    <div class="contrast_part_1">
                      ...
                      <div class="contrast_butt">
                        <div class="contForContrast">
                          <div class="contrast_title"><?php echo __('Contrast', 'bwg_back'); ?></div>
                          ...
                          <div class="tooltip_for_press_contrast"><?php echo __('Press for result', 'bwg_back'); ?></div>
                        </div>
                      </div>
                    </div>				
                  </div><!--
