...
class BWGViewWidgetSlideshow {
  ...
  function form($instance, $id_title, $name_title, $id_gallery_id, $name_gallery_id, $id_width, $name_width, $id_height, $name_height, $id_filmstrip_height, $name_filmstrip_height, $id_effect, $name_effect, $id_interval, $name_interval, $id_shuffle, $name_shuffle, $id_theme_id, $name_theme_id, $id_enable_ctrl_btn, $name_enable_ctrl_btn, $id_enable_autoplay, $name_enable_autoplay) {
    $defaults = array(
    ...
    <p <?php echo ($wd_bwg_options->slideshow_enable_filmstrip ? '' : 'style="display: none;"'); ?>>
      <label for="<?php echo $id_filmstrip_height; ?>"><?php echo __('Filmstrip height:', 'bwg_back'); ?></label>
