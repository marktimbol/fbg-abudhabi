  ...
  public function display() {
    ...
    <?php wp_nonce_field( 'albums_bwg', 'bwg_nonce' ); ?>
      <div>
        ...
        <h2>
          <?php echo __('Albums', 'bwg_back'); ?>
          <a href="" class="add-new-h2" onclick="spider_set_input_value('task', 'add');
                                                 spider_form_submit(event, 'albums_form')"><?php echo __('Add new', 'bwg_back'); ?></a>
        </h2>
      </div>
    ...
    <form class="wrap bwg_form" method="post" action="admin.php?page=albums_bwg" style="width: 98%; float: left;">
      ...
      <table style="clear:both;">
        <tbody>
          ...
          <tr>
            <td class="spider_label"><label for="slug"><?php echo __('Slug:', 'bwg_back'); ?> </label></td>
            <td><input type="text" id="slug" name="slug" value="<?php echo $row->slug; ?>" size="39" /></td>
          </tr>
          <tr>
            <td class="spider_label"><label for="description"><?php echo __('Description:', 'bwg_back'); ?> </label></td>
            <td>
          ...
          <tr>
            <td class="spider_label"><label><?php echo __('Author:', 'bwg_back'); ?> </label></td>
            <td><?php echo get_userdata($row->author)->display_name; ?></td>
          </tr>
          <tr>
            <td class="spider_label"><label for="published1"><?php echo __('Published:', 'bwg_back'); ?> </label></td>
            <td>
          ...
          <tr>
            <td class="spider_label"><label for="url"><?php echo __('Preview image:', 'bwg_back'); ?> </label></td>
            <td>
            <?php 
          ...
          <tr>
            <td class="spider_label"><label for="content-add_media"><?php echo __('Albums And Galleries:', 'bwg_back'); ?> </label></td>
            <td>
            <?php 
            ...
            ?>
              <a href="<?php echo $query_url; ?>" class="wd-btn wd-btn-primary wd-btn-icon wd-btn-add thickbox thickbox-preview" id="content-add_media" title="<?php echo __("Add Images", 'bwg_back'); ?>" onclick="return false;">
                <?php echo __('Add Albums/Galleries', 'bwg_back'); ?>
              </a>              
                    ...
                    foreach($albums_galleries as $alb_gal) {
                      if ($alb_gal) {
                        ...
                        <tr id="tr_<?php echo $alb_gal->id . ":" . $alb_gal->is_album . ":" . $alb_gal->alb_gal_id ?>" style="height:35px;">
                          <td class="connectedSortable table_small_col" title="Drag to re-order"><div class="bwg_img_handle handle" style="margin-left:10px;"></div></td>
