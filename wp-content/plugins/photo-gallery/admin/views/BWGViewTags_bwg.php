  ...
  public function display() {
    ...
    <?php wp_nonce_field( 'tags_bwg', 'bwg_nonce' ); ?>
      <div>
        ...
        <h2><?php echo __('Tags', 'bwg_back'); ?></h2>
      </div>
      <div class="buttons_div_right">
        ...
        <input class="wd-btn wd-btn-primary wd-btn-icon wd-btn-save" type="submit" value="<?php echo __('Save', 'bwg_back'); ?>" onclick="
                                                                    spider_set_input_value('task', 'edit_tags');" />
        <input class="wd-btn wd-btn-primary-red wd-btn-icon wd-btn-delete" type="submit" value="<?php echo __('Delete', 'bwg_back'); ?>" onclick="if (confirm('<?php echo addslashes(__('Do you want to delete selected items?', 'bwg_back')); ?>')) {
              ...
              <tr id="tr_<?php echo $row_data->term_id; ?>" <?php echo $alternate; ?>>
                ...
                <td id="td_name_<?php echo $row_data->term_id; ?>" >
                  <a class="pointer" id="name<?php echo $row_data->term_id; ?>"
                     ...
                     title="<?php echo __('Edit', 'bwg_back'); ?>"><?php echo $row_data->name; ?></a>
                </td>
                <td id="td_slug_<?php echo $row_data->term_id; ?>">
                  <a class="pointer"
                     id="slug<?php echo $row_data->term_id; ?>"
                     onclick="edit_tag(<?php echo $row_data->term_id; ?>)" 
                     title="<?php echo __('Edit', 'bwg_back'); ?>"><?php echo $row_data->slug; ?></a>
                </td>
                <td class="table_big_col" id="td_count_<?php echo $row_data->term_id; ?>" >
                  <a class="pointer"
                     id="count<?php echo $row_data->term_id; ?>"
                     title="<?php echo __('Edit', 'bwg_back'); ?>"><?php echo $this->model->get_count_of_images($row_data->term_id); ?></a>
                </td>
                <td class="table_big_col" id="td_edit_<?php echo $row_data->term_id; ?>">
                  <a class="bwg_img_edit" title="<?php echo __('Edit', 'bwg_back'); ?>" onclick="edit_tag(<?php echo $row_data->term_id; ?>)"></a>
                </td>
