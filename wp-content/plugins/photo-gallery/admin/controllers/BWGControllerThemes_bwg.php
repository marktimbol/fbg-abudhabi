...
class BWGControllerThemes_bwg {
  ...
  public function save_db() {
    ...
    $thumb_gal_title_margin = (isset($_POST['thumb_gal_title_margin']) ? esc_html(stripslashes( $_POST['thumb_gal_title_margin'])) : '');
    $thumb_gal_title_font_style = (isset($_POST['thumb_gal_title_font_style']) ? esc_html(stripslashes( $_POST['thumb_gal_title_font_style'])) : $album_compact_back_font_style);
    $thumb_gal_title_font_color = (isset($_POST['thumb_gal_title_font_color']) ? esc_html(stripslashes( $_POST['thumb_gal_title_font_color'])) : $album_compact_back_font_color);	
    $thumb_gal_title_shadow = (isset($_POST['thumb_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['thumb_gal_title_shadow'])) : '');
    $thumb_gal_title_font_size = (isset($_POST['thumb_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['thumb_gal_title_font_size'])) : $album_compact_back_font_size);
    $thumb_gal_title_font_weight = (isset($_POST['thumb_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['thumb_gal_title_font_weight'])) : $album_compact_back_font_weight);   
    $thumb_gal_title_align = (isset($_POST['thumb_gal_title_align']) ? esc_html(stripslashes( $_POST['thumb_gal_title_align'])) : ''); 
    
    $album_compact_gal_title_margin = (isset($_POST['album_compact_gal_title_margin']) ? esc_html(stripslashes( $_POST['album_compact_gal_title_margin'])) : '');
    $album_compact_gal_title_font_style = (isset($_POST['album_compact_gal_title_font_style']) ? esc_html(stripslashes( $_POST['album_compact_gal_title_font_style'])) : $album_compact_back_font_style);
    $album_compact_gal_title_font_color = (isset($_POST['album_compact_gal_title_font_color']) ? esc_html(stripslashes( $_POST['album_compact_gal_title_font_color'])) : $album_compact_back_font_color);	
    $album_compact_gal_title_shadow = (isset($_POST['album_compact_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['album_compact_gal_title_shadow'])) : '');
    $album_compact_gal_title_font_size = (isset($_POST['album_compact_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['album_compact_gal_title_font_size'])) : $album_compact_back_font_size);
    $album_compact_gal_title_font_weight = (isset($_POST['album_compact_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['album_compact_gal_title_font_weight'])) : $album_compact_back_font_weight);
    $album_compact_gal_title_align = (isset($_POST['album_compact_gal_title_align']) ? esc_html(stripslashes( $_POST['album_compact_gal_title_align'])) : '');
    
    $album_extended_gal_title_margin = (isset($_POST['album_extended_gal_title_margin']) ? esc_html(stripslashes( $_POST['album_extended_gal_title_margin'])) : '');
    $album_extended_gal_title_font_style = (isset($_POST['album_extended_gal_title_font_style']) ? esc_html(stripslashes( $_POST['album_extended_gal_title_font_style'])) : $album_extended_back_font_style);
    $album_extended_gal_title_font_color = (isset($_POST['album_extended_gal_title_font_color']) ? esc_html(stripslashes( $_POST['album_extended_gal_title_font_color'])) : $album_extended_back_font_color);	
    $album_extended_gal_title_shadow = (isset($_POST['album_extended_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['album_extended_gal_title_shadow'])) : '');
    $album_extended_gal_title_font_size = (isset($_POST['album_extended_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['album_extended_gal_title_font_size'])) : $album_extended_back_font_size);
    $album_extended_gal_title_font_weight = (isset($_POST['album_extended_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['album_extended_gal_title_font_weight'])) : $album_extended_back_font_weight);
    $album_extended_gal_title_align = (isset($_POST['album_extended_gal_title_align']) ? esc_html(stripslashes( $_POST['album_extended_gal_title_align'])) : '');
    
    $album_masonry_gal_title_margin = (isset($_POST['album_masonry_gal_title_margin']) ? esc_html(stripslashes( $_POST['album_masonry_gal_title_margin'])) : '');
    $album_masonry_gal_title_font_style = (isset($_POST['album_masonry_gal_title_font_style']) ? esc_html(stripslashes( $_POST['album_masonry_gal_title_font_style'])) : $album_masonry_back_font_style);
    $album_masonry_gal_title_font_color = (isset($_POST['album_masonry_gal_title_font_color']) ? esc_html(stripslashes( $_POST['album_masonry_gal_title_font_color'])) : $album_masonry_back_font_color);	
    $album_masonry_gal_title_shadow = (isset($_POST['album_masonry_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['album_masonry_gal_title_shadow'])) : '');
    $album_masonry_gal_title_font_size = (isset($_POST['album_masonry_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['album_masonry_gal_title_font_size'])) : $album_masonry_back_font_size);
    $album_masonry_gal_title_font_weight = (isset($_POST['album_masonry_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['album_masonry_gal_title_font_weight'])) : $album_masonry_back_font_weight);
    $album_masonry_gal_title_align = (isset($_POST['album_masonry_gal_title_align']) ? esc_html(stripslashes( $_POST['album_masonry_gal_title_align'])) : '');
    
    $masonry_thumb_gal_title_margin = (isset($_POST['masonry_thumb_gal_title_margin']) ? esc_html(stripslashes( $_POST['masonry_thumb_gal_title_margin'])) : '');
    $masonry_thumb_gal_title_font_style = (isset($_POST['masonry_thumb_gal_title_font_style']) ? esc_html(stripslashes( $_POST['masonry_thumb_gal_title_font_style'])) : $album_compact_back_font_style);
    $masonry_thumb_gal_title_font_color = (isset($_POST['masonry_thumb_gal_title_font_color']) ? esc_html(stripslashes( $_POST['masonry_thumb_gal_title_font_color'])) : $album_compact_back_font_color);	
    $masonry_thumb_gal_title_shadow = (isset($_POST['masonry_thumb_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['masonry_thumb_gal_title_shadow'])) : '');
    $masonry_thumb_gal_title_font_size = (isset($_POST['masonry_thumb_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['masonry_thumb_gal_title_font_size'])) : $album_compact_back_font_size);
    $masonry_thumb_gal_title_font_weight = (isset($_POST['masonry_thumb_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['masonry_thumb_gal_title_font_weight'])) : $album_compact_back_font_weight); 
    $masonry_thumb_gal_title_align = (isset($_POST['masonry_thumb_gal_title_align']) ? esc_html(stripslashes( $_POST['masonry_thumb_gal_title_align'])) : '');

    $mosaic_thumb_gal_title_margin = (isset($_POST['mosaic_thumb_gal_title_margin']) ? esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_margin'])) : '');
    $mosaic_thumb_gal_title_font_style = (isset($_POST['mosaic_thumb_gal_title_font_style']) ? esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_font_style'])) : $album_compact_back_font_style);
    $mosaic_thumb_gal_title_font_color = (isset($_POST['mosaic_thumb_gal_title_font_color']) ? esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_font_color'])) : $album_compact_back_font_color);	
    $mosaic_thumb_gal_title_shadow = (isset($_POST['mosaic_thumb_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_shadow'])) : '');
    $mosaic_thumb_gal_title_font_size = (isset($_POST['mosaic_thumb_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_font_size'])) : $album_compact_back_font_size);
    $mosaic_thumb_gal_title_font_weight = (isset($_POST['mosaic_thumb_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_font_weight'])) : $album_compact_back_font_weight); 
    $mosaic_thumb_gal_title_align = (isset($_POST['mosaic_thumb_gal_title_align']) ? esc_html(stripslashes( $_POST['mosaic_thumb_gal_title_align'])) : '');
    
    $image_browser_gal_title_margin = (isset($_POST['image_browser_gal_title_margin']) ? esc_html(stripslashes( $_POST['image_browser_gal_title_margin'])) : '');
    $image_browser_gal_title_font_style = (isset($_POST['image_browser_gal_title_font_style']) ? esc_html(stripslashes( $_POST['image_browser_gal_title_font_style'])) : '');
    $image_browser_gal_title_font_color = (isset($_POST['image_browser_gal_title_font_color']) ? esc_html(stripslashes( $_POST['image_browser_gal_title_font_color'])) : 'CCCCCC');	
    $image_browser_gal_title_shadow = (isset($_POST['image_browser_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['image_browser_gal_title_shadow'])) : '');
    $image_browser_gal_title_font_size = (isset($_POST['image_browser_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['image_browser_gal_title_font_size'])) : 16);
    $image_browser_gal_title_font_weight = (isset($_POST['image_browser_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['image_browser_gal_title_font_weight'])) : 'bold'); 
    $image_browser_gal_title_align = (isset($_POST['image_browser_gal_title_align']) ? esc_html(stripslashes( $_POST['image_browser_gal_title_align'])) : '');
    
     $blog_style_gal_title_margin = (isset($_POST['blog_style_gal_title_margin']) ? esc_html(stripslashes( $_POST['blog_style_gal_title_margin'])) : '');
    $blog_style_gal_title_font_style = (isset($_POST['blog_style_gal_title_font_style']) ? esc_html(stripslashes( $_POST['blog_style_gal_title_font_style'])) : '');
    $blog_style_gal_title_font_color = (isset($_POST['blog_style_gal_title_font_color']) ? esc_html(stripslashes( $_POST['blog_style_gal_title_font_color'])) : 'CCCCCC');	
    $blog_style_gal_title_shadow = (isset($_POST['blog_style_gal_title_shadow']) ?  esc_html(stripslashes( $_POST['blog_style_gal_title_shadow'])) : '');
    $blog_style_gal_title_font_size = (isset($_POST['blog_style_gal_title_font_size']) ? (int) esc_html(stripslashes( $_POST['blog_style_gal_title_font_size'])) : 16);
    $blog_style_gal_title_font_weight = (isset($_POST['blog_style_gal_title_font_weight']) ? esc_html(stripslashes( $_POST['blog_style_gal_title_font_weight'])) : 'bold'); 
    $blog_style_gal_title_align = (isset($_POST['blog_style_gal_title_align']) ? esc_html(stripslashes( $_POST['blog_style_gal_title_align'])) : '');
    ...
    $themes = array(
      ...
      'thumb_gal_title_font_color' => $thumb_gal_title_font_color,
      'thumb_gal_title_font_style' => $thumb_gal_title_font_style,
      'thumb_gal_title_font_size' => $thumb_gal_title_font_size,
      'thumb_gal_title_font_weight' => $thumb_gal_title_font_weight,
      'thumb_gal_title_margin' => $thumb_gal_title_margin,
      'thumb_gal_title_shadow' => $thumb_gal_title_shadow,
      'thumb_gal_title_align' => $thumb_gal_title_align,
      ...
      'blog_style_gal_title_font_color' => $blog_style_gal_title_font_color,
      'blog_style_gal_title_font_style' => $blog_style_gal_title_font_style,
      'blog_style_gal_title_font_size' => $blog_style_gal_title_font_size,
      'blog_style_gal_title_font_weight' => $blog_style_gal_title_font_weight,
      'blog_style_gal_title_margin' => $blog_style_gal_title_margin,
      'blog_style_gal_title_shadow' => $blog_style_gal_title_shadow,
      'blog_style_gal_title_align' => $blog_style_gal_title_align,
      ...
      'image_browser_gal_title_font_color' => $image_browser_gal_title_font_color,
      'image_browser_gal_title_font_style' => $image_browser_gal_title_font_style,
      'image_browser_gal_title_font_size' => $image_browser_gal_title_font_size,
      'image_browser_gal_title_font_weight' => $image_browser_gal_title_font_weight,
      'image_browser_gal_title_margin' => $image_browser_gal_title_margin,
      'image_browser_gal_title_shadow' => $image_browser_gal_title_shadow,
      'image_browser_gal_title_align' => $image_browser_gal_title_align,      
      ...
      'album_compact_gal_title_font_color' => $album_compact_gal_title_font_color,
      'album_compact_gal_title_font_style' => $album_compact_gal_title_font_style,
      'album_compact_gal_title_font_size' => $album_compact_gal_title_font_size,
      'album_compact_gal_title_font_weight' => $album_compact_gal_title_font_weight,
      'album_compact_gal_title_margin' => $album_compact_gal_title_margin,
      'album_compact_gal_title_shadow'=> $album_compact_gal_title_shadow,
      'album_compact_gal_title_align'=> $album_compact_gal_title_align,
      ...
      'album_extended_gal_title_font_color' => $album_extended_gal_title_font_color,
      'album_extended_gal_title_font_style' => $album_extended_gal_title_font_style,
      'album_extended_gal_title_font_size' => $album_extended_gal_title_font_size,
      'album_extended_gal_title_font_weight' => $album_extended_gal_title_font_weight,
      'album_extended_gal_title_margin' => $album_extended_gal_title_margin,
      'album_extended_gal_title_shadow'=> $album_extended_gal_title_shadow, 
      'album_extended_gal_title_align'=> $album_extended_gal_title_align,       
      ...
      'masonry_thumb_gal_title_font_color' => $masonry_thumb_gal_title_font_color,
      'masonry_thumb_gal_title_font_style' => $masonry_thumb_gal_title_font_style,
      'masonry_thumb_gal_title_font_size' => $masonry_thumb_gal_title_font_size,
      'masonry_thumb_gal_title_font_weight' => $masonry_thumb_gal_title_font_weight,
      'masonry_thumb_gal_title_margin' => $masonry_thumb_gal_title_margin,
      'masonry_thumb_gal_title_shadow'=> $masonry_thumb_gal_title_shadow, 
      'masonry_thumb_gal_title_align'=> $masonry_thumb_gal_title_align,
      ...
      'mosaic_thumb_gal_title_font_color' => $mosaic_thumb_gal_title_font_color,
      'mosaic_thumb_gal_title_font_style' => $mosaic_thumb_gal_title_font_style,
      'mosaic_thumb_gal_title_font_size' => $mosaic_thumb_gal_title_font_size,
      'mosaic_thumb_gal_title_font_weight' => $mosaic_thumb_gal_title_font_weight,
      'mosaic_thumb_gal_title_margin' => $mosaic_thumb_gal_title_margin,
      'mosaic_thumb_gal_title_shadow'=> $mosaic_thumb_gal_title_shadow,
      'mosaic_thumb_gal_title_align'=> $mosaic_thumb_gal_title_align,
      ...
      'album_masonry_gal_title_font_color' => $album_masonry_gal_title_font_color,
      'album_masonry_gal_title_font_style' => $album_masonry_gal_title_font_style,
      'album_masonry_gal_title_font_size' => $album_masonry_gal_title_font_size,
      'album_masonry_gal_title_font_weight' => $album_masonry_gal_title_font_weight,
      'album_masonry_gal_title_margin' => $album_masonry_gal_title_margin,
      'album_masonry_gal_title_shadow' => $album_masonry_gal_title_shadow,
      'album_masonry_gal_title_align' => $album_masonry_gal_title_align,
