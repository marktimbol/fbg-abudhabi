    ...
    public static function generate($atts) {
        ...
        */
        while ( $loop->have_posts() ) {
            ...
            $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID) , 'fdg-image');
            ...
            */
            if ( $params['show_featured_image'] === 'true' ) {
                ...
                $featured_image = '<div class="fusion-events-thumbnail hover-type-none">';
            ...
            */
            if ( $params['show_more_button'] === 'true' ) {
                ...
                $buttons = '<div class="tc-events-overlay">
						<div class="dt">
							<div class="dtc">
								<a href="'.$post_url.'" class="button button-round"> ' . $eventButtonLink . ' </a>
							</div>
						</div>
						<div class="event-date"><span>'.date('d M', strtotime(get_post_meta( get_the_ID(), '_EventStartDate', true ))).'</span></div>
					</div>';
            }
            ...
            */
            $out.= '<div class="wp-posts-carousel-slide slides-' . $params['items_to_show'] . '">';
                $out.= '<div class="wp-posts-carousel-container">';
                    ...
                    $out.= '<div class="wp-posts-carousel-details" style="background-color: rgba(255,255,255,0.9);">';
						...
						$out.= '<span>';
						$out.= date('d M Y', strtotime(get_post_meta( get_the_ID(), '_EventStartDate', true )));
						$out.= '</span>';
						$out.= '</div>';
